...
var _getUserAgent = require('./get-user-agent');
...
function createHttpClient(axios, options) {
  ...
  if ((0, _getUserAgent.isNode)()) {
    config.headers['user-agent'] = 'node.js/' + (0, _getUserAgent.getNodeVersion)();
